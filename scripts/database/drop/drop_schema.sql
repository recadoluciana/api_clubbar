...
DROP TABLE IF EXISTS coramensagem;
DROP TABLE IF EXISTS coraduvida;
...
DROP TABLE IF EXISTS eventolotepreco;
DROP TABLE IF EXISTS eventolote;
DROP TABLE IF EXISTS eventosetor;
DROP TABLE IF EXISTS eventodescricao;
DROP TABLE IF EXISTS evento;
DROP TABLE IF EXISTS agendamensal;
...
DROP TABLE IF EXISTS lojaestilomusical;
DROP TABLE IF EXISTS atracao;
DROP TABLE IF EXISTS organizacaoestilomusical;
DROP TABLE IF EXISTS estilomusical;
DROP TABLE IF EXISTS cardapioreajuste;
DROP TABLE IF EXISTS cardapioprogramacao;
DROP TABLE IF EXISTS cardapioitem;
DROP TABLE IF EXISTS cardapioversaocategoria;
DROP TABLE IF EXISTS cardapioversao;
DROP TABLE IF EXISTS cardapio;
DROP TABLE IF EXISTS cardapiomodeloproduto;
DROP TABLE IF EXISTS cardapiomodelocategoria;
DROP TABLE IF EXISTS cardapiomodeloitem;
DROP TABLE IF EXISTS produtocategoriaorg;
DROP TABLE IF EXISTS cardapiomodelo;
DROP TABLE IF EXISTS produto;
DROP TABLE IF EXISTS categoriaorg;
DROP TABLE IF EXISTS categoriapadrao;

...
CREATE TABLE leadparceiro (
  ...
  CONSTRAINT uq_leadparceiro_nmorganizacao UNIQUE (nmorganizacao),
  CONSTRAINT uq_leadparceiro_email UNIQUE (email),
  CONSTRAINT uq_leadparceiro_telefone UNIQUE (telefone),
...
CREATE TABLE leadestabelecimento (
  ...
  vrtaxaminimaingresso DECIMAL(10,2) NOT NULL DEFAULT 2.99,
...
CREATE TABLE titularfinanceiro (
  ...
  sittitular VARCHAR(15) NOT NULL DEFAULT 'ATIVO',
  dtcriacao DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  INDEX ix_titularfinanceiro_sittitular (sittitular),
...
CREATE TABLE leadestabelecimentocontrato (
  ...
  nmrazaosocial VARCHAR(160) NULL,
  cepcontratante VARCHAR(9) NULL,
  enderecocontratante VARCHAR(255) NULL,
  numerocontratante VARCHAR(20) NULL,
  complementocontratante VARCHAR(120) NULL,
  bairrocontratante VARCHAR(120) NULL,
  estado_id_contratante BIGINT NULL,
  cidade_id_contratante BIGINT NULL,
...
CREATE TABLE atracaoorganizacaoestilomusical (
  ...
  CONSTRAINT fk_atracaoorgestilo_estilo FOREIGN KEY (organizacaoestilomusical_id)

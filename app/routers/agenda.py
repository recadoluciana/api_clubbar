...
def listar(loja_id:int,ano:int=Query(ge=2000,le=2200),mes:int=Query(ge=1,le=12),payload=Depends(get_usuario_logado),db:Session=Depends(get_db)):
    ...
    for e in eventos:
        ...
        saida.append({"evento_id":e.evento_id,"organizacao_id":e.organizacao_id,"loja_id":e.loja_id,"nmtituloevento":e.nmtituloevento,"dspoliticacancelamento":e.dspoliticacancelamento,"dtinicioevento":e.dtinicioevento,"dtfimevento":e.dtfimevento,"qtcapacidadeevento":e.qtcapacidadeevento,"statusevento":e.statusevento,"urlbannerevento":imagem_evento(db, e),"atracoes":[{"eventoatracao_id":p.eventoatracao_id,"atracao_id":p.atracao_id,"dtinicioatracao":p.dtinicioatracao,"dtfimatracao":p.dtfimatracao,"nrminutoduracao":p.nrminutoduracao,"atracao":{"atracao_id":p.atracao.atracao_id,"organizacao_id":p.atracao.organizacao_id,"nmatracao":p.atracao.nmatracao,"dsestilomusical":p.atracao.dsestilomusical,"estilos":[{"estilomusical_id":x.organizacaoestilomusical_id,"nmestilomusical":x.nmestilomusical} for x in p.atracao.estilos],"urlbanneratracao":p.atracao.urlbanneratracao,"dsatracao":p.atracao.dsatracao}} for p in ps]})
    return saida

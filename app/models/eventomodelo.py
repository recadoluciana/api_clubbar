...
class EventoModelo(Base):
    ...
    tipolocalevento = Column(Enum("ESTABELECIMENTO", "OUTRO", name="eventomodelo_tipo_local"), nullable=False, server_default="ESTABELECIMENTO")
    nrceplocalevento = Column(String(9))
